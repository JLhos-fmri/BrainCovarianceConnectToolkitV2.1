...
D.COVEDIT = uicontrol('parent',D.fig,...
    'units','normalized',...
    'pos',[0.15,0.76,0.7,0.08],...
    'style','edit',...
    'string','NULL');
D.COVSel = uicontrol('parent',D.fig,...
    'units','normalized',...
    'pos',[0.86,0.76,0.09,0.08],...
    'style','pushbutton',...
    'string','...');
...
D.mask = uicontrol('parent',D.fig,...
    'units','norm',...
    'pos',[0.05,0.66,0.1,0.08],...
    'style','text',...
    'Fontsize',10,...
    'string','mask');
D.maskedit = uicontrol('parent',D.fig,...
    'units','norm',...
    'pos',[0.15,0.66,0.7,0.08],...
    'style','edit',...
    'string','Defaults');
D.masksel = uicontrol('parent',D.fig,...
    'units','norm',...
    'pos',[0.86,0.66,0.09,0.08],...
    'style','pushbutton',...
    'string','...');
...
BCCT_Mod_matrixcomputemain(Parameter)
