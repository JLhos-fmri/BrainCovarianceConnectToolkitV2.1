function AS_MatrixShowFinalResPerm(enhanind)
if nargin<1
    enhanind = [];
end
[mpat,mnam,mext] = fileparts(which('AS_MatrixShowFinalRes.m'));
...
outdir = uigetdir(pwd,'Output dir');
...
POS2 = [10,10+Bsize2*1,Bsize2,Bsize2];
...
P2 = zeros(size(P));
P2(PindBonf) = 1;
H = figure('pos',POS2,'name','Group 1: R(p=1)');
ax = axes('parent',H,'unit','norm','pos',[0.1,0.1,0.8,0.8]);
...
saveas(H,[outdir,filesep,'Group1R005.fig'])
set(H,'PaperPositionMode','manual');
set(H,'PaperUnits','inch')
set(H,'Paperposition',[1,1,POS2(3)*3/300,POS2(4)*3/300]);
print(H,[outdir,filesep,'Group1R005.tif'],'-dtiff','-r300')
...
saveas(H,[outdir,filesep,'Group1R005BONF.fig'])
set(H,'PaperPositionMode','manual');
set(H,'PaperUnits','inch')
set(H,'Paperposition',[1,1,POS2(3)*3/300,POS2(4)*3/300]);
print(H,[outdir,filesep,'Group1R005BONF.tif'],'-dtiff','-r300')
%%
H = figure('pos',POS2,'name','Group 1: Z(p=1)');
ax = axes('parent',H,'unit','norm','pos',[0.1,0.1,0.8,0.8]);
image(R,'parent',ax,'CDataMapping','scaled');
axis(ax,[-0.5,NROI+1.5,-0.5,NROI+1.5]);
axis(ax,'off');
...
saveas(H,[outdir,filesep,'Group1Z005.fig'])
set(H,'PaperPositionMode','manual');
set(H,'PaperUnits','inch')
set(H,'Paperposition',[1,1,POS2(3)*3/300,POS2(4)*3/300]);
print(H,[outdir,filesep,'Group1Z005.tif'],'-dtiff','-r300')
...
saveas(H,[outdir,filesep,'Group1Z005BONF.fig'])
set(H,'PaperPositionMode','manual');
set(H,'PaperUnits','inch')
set(H,'Paperposition',[1,1,POS2(3)*3/300,POS2(4)*3/300]);
print(H,[outdir,filesep,'Group1Z005BONF.tif'],'-dtiff','-r300')
%%
R = ShowRes2.R;
P = ShowRes2.P;
Z = ShowRes2.Z;
...
P2 = zeros(size(P));
P2(PindBonf) = 1;
H = figure('pos',POS2,'name','Group 2: R(p=1)');
ax = axes('parent',H,'unit','norm','pos',[0.1,0.1,0.8,0.8]);
image(R,'parent',ax,'CDataMapping','scaled');
axis(ax,[-0.5,NROI+1.5,-0.5,NROI+1.5]);
axis(ax,'off');
...
saveas(H,[outdir,filesep,'Group2R005.fig'])
set(H,'PaperPositionMode','manual');
set(H,'PaperUnits','inch')
set(H,'Paperposition',[1,1,POS2(3)*3/300,POS2(4)*3/300]);
print(H,[outdir,filesep,'Group2R005.tif'],'-dtiff','-r300')
...
saveas(H,[outdir,filesep,'Group2R005BONF.fig'])
set(H,'PaperPositionMode','manual');
set(H,'PaperUnits','inch')
set(H,'Paperposition',[1,1,POS2(3)*3/300,POS2(4)*3/300]);
print(H,[outdir,filesep,'Group2R005BONF.tif'],'-dtiff','-r300')
%%
H = figure('pos',POS2,'name','Group 2: Z(p=1)');
ax = axes('parent',H,'unit','norm','pos',[0.1,0.1,0.8,0.8]);
image(R,'parent',ax,'CDataMapping','scaled');
axis(ax,[-0.5,NROI+1.5,-0.5,NROI+1.5]);
axis(ax,'off');
...
saveas(H,[outdir,filesep,'Group2Z005.fig'])
set(H,'PaperPositionMode','manual');
set(H,'PaperUnits','inch')
set(H,'Paperposition',[1,1,POS2(3)*3/300,POS2(4)*3/300]);
print(H,[outdir,filesep,'Group2Z005.tif'],'-dtiff','-r300')
...
saveas(H,[outdir,filesep,'Group2Z005BONF.fig'])
set(H,'PaperPositionMode','manual');
set(H,'PaperUnits','inch')
set(H,'Paperposition',[1,1,POS2(3)*3/300,POS2(4)*3/300]);
print(H,[outdir,filesep,'Group2Z005BONF.tif'],'-dtiff','-r300')
...
saveas(H,[outdir,filesep,'StatR.fig'])
set(H,'PaperPositionMode','manual');
set(H,'PaperUnits','inch')
set(H,'Paperposition',[1,1,POS2(3)*3/300,POS2(4)*3/300]);
print(H,[outdir,filesep,'StatR.tif'],'-dtiff','-r300')

H = figure('pos',POS2,'name','Statistical P(Z)');
ax = axes('parent',H,'unit','norm','pos',[0.1,0.1,0.8,0.8]);
...
saveas(H,[outdir,filesep,'StatZ.fig'])
set(H,'PaperPositionMode','manual');
set(H,'PaperUnits','inch')
set(H,'Paperposition',[1,1,POS2(3)*3/300,POS2(4)*3/300]);
print(H,[outdir,filesep,'StatZ.tif'],'-dtiff','-r300')
...
saveas(H,[outdir,filesep,'StatR005.fig'])
set(H,'PaperPositionMode','manual');
set(H,'PaperUnits','inch')
set(H,'Paperposition',[1,1,POS2(3)*3/300,POS2(4)*3/300]);
print(H,[outdir,filesep,'StatR005.tif'],'-dtiff','-r300')
...
saveas(H,[outdir,filesep,'StatZ005.fig'])
set(H,'PaperPositionMode','manual');
set(H,'PaperUnits','inch')
set(H,'Paperposition',[1,1,POS2(3)*3/300,POS2(4)*3/300]);
print(H,[outdir,filesep,'StatZ005.tif'],'-dtiff','-r300')
%
PvalShow3 = PvalShow;
THRV2 = 1-THRBONF;
THRV3 = 1-THRBONF*2;
...
saveas(H,[outdir,filesep,'StatR005BONF.fig'])
set(H,'PaperPositionMode','manual');
set(H,'PaperUnits','inch')
set(H,'Paperposition',[1,1,POS2(3)*3/300,POS2(4)*3/300]);
print(H,[outdir,filesep,'StatR005BONF.tif'],'-dtiff','-r300')
...
saveas(H,[outdir,filesep,'StatZ005BONF.fig'])
set(H,'PaperPositionMode','manual');
set(H,'PaperUnits','inch')
set(H,'Paperposition',[1,1,POS2(3)*3/300,POS2(4)*3/300]);
print(H,[outdir,filesep,'StatZ005BONF.tif'],'-dtiff','-r300')