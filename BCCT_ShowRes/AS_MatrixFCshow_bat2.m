function AS_MatrixFCshow_bat2(indir,outdir,enhanind)
if nargin<3
    enhanind = [];
end
...
Bsize2 = Bsize/3;
% midsize = [Hsize(3)/2,Hsize(4)/2];
POS1 = [Hsize(3)/2-Bsize2*1.5,10+Bsize2*2,Bsize2*3,Bsize2];
POS2 = [Hsize(3)/2-Bsize2*1.5,10+Bsize2*1,Bsize2*3,Bsize2];
POS3 = [Hsize(3)/2-Bsize2*1.5,10+Bsize2*0,Bsize2*3,Bsize2];
H1 = figure('pos',POS1);
H2 = figure('pos',POS2);
H3 = figure('pos',POS3);
maxZ = max(abs(Z(:)));
